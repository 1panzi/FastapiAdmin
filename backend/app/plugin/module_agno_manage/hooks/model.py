...
from sqlalchemy import Integer, Boolean, Text, DateTime, JSONB, String
from sqlalchemy.orm import Mapped, mapped_column

from app.core.base_model import ModelMixin, UserMixin


class AgHooksModel(ModelMixin, UserMixin):
    """
    hook表
    """
    ...
    config: Mapped[dict | None] = mapped_column(JSONB, nullable=True, comment='额外配置参数')
