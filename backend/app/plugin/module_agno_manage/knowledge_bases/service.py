...
from .agno_catalog import list_knowledge_types, KnowledgeTypeInfo
...
class AgKnowledgeBaseService:
    ...
    @classmethod
    async def detail_knowledge_bases_service(cls, auth: AuthSchema, id: int) -> dict:
        """
        详情
    ...
    async def batch_export_knowledge_bases_service(cls, obj_list: list[dict]) -> bytes:
        ...
        mapping_dict = {
            ...
            'uuid': '',
            'name': '知识库名称',
            'vectordb_id': '关联向量数据库ID',
            'max_results': '最大检索结果数',
            'reader_type': '文档读取器类型(pdf/web/docx/csv/json/text)',
            'reader_config': '读取器配置参数',
            'default_filters': '默认搜索过滤条件',
            'status': '',
            'description': '',
            'created_time': '',
            'updated_time': '',
    ...
    @classmethod
    async def batch_import_knowledge_bases_service(cls, auth: AuthSchema, file: UploadFile, update_support: bool = False) -> str:
        """
        批量导入
        ...
        header_dict = {
            ...
            '': 'uuid',
            '知识库名称': 'name',
            '关联向量数据库ID': 'vectordb_id',
            '最大检索结果数': 'max_results',
            '文档读取器类型(pdf/web/docx/csv/json/text)': 'reader_type',
            '读取器配置参数': 'reader_config',
            '默认搜索过滤条件': 'default_filters',
            '': 'status',
            '': 'description',
            '': 'created_time',
            '': 'updated_time',
    ...
    @classmethod
    async def import_template_download_knowledge_bases_service(cls) -> bytes:
        """
        下载导入模板
        ...
        header_list = [
            ...
            '关联向量数据库ID',
            '最大检索结果数',
            '文档读取器类型(pdf/web/docx/csv/json/text)',
            '读取器配置参数',
            '默认搜索过滤条件',
            '',
            '',
