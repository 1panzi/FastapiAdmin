...
class AgMcpServerCreateSchema(BaseModel):
    ...
    command: str | None = Field(default=None, description='stdio启动命令')
    url: str | None = Field(default=None, description='HTTP/SSE服务地址')
    env_config: dict | None = Field(default=None, description='环境变量配置')
    include_tools: dict | None = Field(default=None, description='仅包含的工具列表')
    exclude_tools: dict | None = Field(default=None, description='排除的工具列表')
    tool_name_prefix: str | None = Field(default=None, description='工具名称前缀')
    timeout_seconds: int | None = Field(default=None, description='连接超时秒数')
    refresh_connection: bool | None = Field(default=None, description='是否刷新连接')
