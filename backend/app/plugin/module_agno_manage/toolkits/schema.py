...
class AgToolkitCreateSchema(BaseModel):
    ...
    instructions: str | None = Field(default=None, description='工具使用说明')
    requires_confirmation: bool | None = Field(default=None, description='是否需要确认')
    approval_type: str | None = Field(default=None, description='审批类型(NULL/required/audit)')
    stop_after_call: bool | None = Field(default=None, description='调用后是否停止')
