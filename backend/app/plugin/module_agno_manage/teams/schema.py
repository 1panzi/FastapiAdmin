...
class AgTeamCreateSchema(BaseModel):
    ...
    model_id: int | None = Field(default=None, description='主模型ID')
    memory_manager_id: int | None = Field(default=None, description='记忆管理器ID')
    mode: str | None = Field(default=None, description='协作模式(route/coordinate/collaborate/tasks)')
    respond_directly: bool | None = Field(default=None, description='是否直接响应（不经过协调）')
    delegate_to_all_members: bool | None = Field(default=None, description='是否分发给所有成员')
    determine_input_for_members: bool | None = Field(default=None, description='是否为成员决定输入内容')
    max_iterations: int | None = Field(default=None, description='最大迭代次数')
    instructions: str | None = Field(default=None, description='Team指令')
    ...
    add_team_history_to_members: bool | None = Field(default=None, description='是否将Team历史传给成员')
    num_team_history_runs: int | None = Field(default=None, description='传给成员的历史运行次数')
    share_member_interactions: bool | None = Field(default=None, description='是否共享成员交互记录')
    add_member_tools_to_context: bool | None = Field(default=None, description='是否将成员工具加入上下文')
    read_chat_history: bool | None = Field(default=None, description='是否读取聊天历史')
