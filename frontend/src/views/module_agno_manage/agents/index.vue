  ...
  <div class="app-container">
        ...
        <div v-show="visible" class="search-container">
          ...
          >
            ...
            <el-form-item label="是否开启推理" prop="reasoning">
              <el-input v-model="queryFormData.reasoning" placeholder="请输入是否开启推理" clearable />
            </el-form-item>
            ...
            <el-form-item label="是否开启学习" prop="learning">
              <el-input v-model="queryFormData.learning" placeholder="请输入是否开启学习" clearable />
            </el-form-item>
            ...
            <el-form-item label="是否将知识库内容加入上下文" prop="add_knowledge_to_context">
              <el-input v-model="queryFormData.add_knowledge_to_context" placeholder="请输入是否将知识库内容加入上下文" clearable />
            </el-form-item>
            ...
            <el-form-item label="是否将记忆加入上下文" prop="add_memories_to_context">
              <el-input v-model="queryFormData.add_memories_to_context" placeholder="请输入是否将记忆加入上下文" clearable />
            </el-form-item>
            <el-form-item label="是否将历史记录加入上下文" prop="add_history_to_context">
              <el-input v-model="queryFormData.add_history_to_context" placeholder="请输入是否将历史记录加入上下文" clearable />
            </el-form-item>
            ...
            <el-form-item label="输出结构体JSON Schema" prop="output_schema">
              <el-input v-model="queryFormData.output_schema" placeholder="请输入输出结构体JSON Schema" clearable />
            </el-form-item>
            ...
            <el-form-item label="是否使用JSON输出模式" prop="use_json_mode">
              <el-input v-model="queryFormData.use_json_mode" placeholder="请输入是否使用JSON输出模式" clearable />
            </el-form-item>
            <el-form-item label="是否使用结构化输出" prop="structured_outputs">
              <el-input v-model="queryFormData.structured_outputs" placeholder="请输入是否使用结构化输出" clearable />
            </el-form-item>
            <el-form-item label="是否解析响应" prop="parse_response">
              <el-input v-model="queryFormData.parse_response" placeholder="请输入是否解析响应" clearable />
            </el-form-item>
            ...
            <el-form-item label="是否指数退避重试" prop="exponential_backoff">
              <el-input v-model="queryFormData.exponential_backoff" placeholder="请输入是否指数退避重试" clearable />
            </el-form-item>
            <el-form-item label="是否将当前时间加入上下文" prop="add_datetime_to_context">
              <el-input v-model="queryFormData.add_datetime_to_context" placeholder="请输入是否将当前时间加入上下文" clearable />
            </el-form-item>
            <el-form-item label="是否将Agent名称加入上下文" prop="add_name_to_context">
              <el-input v-model="queryFormData.add_name_to_context" placeholder="请输入是否将Agent名称加入上下文" clearable />
            </el-form-item>
            <el-form-item label="是否压缩工具结果" prop="compress_tool_results">
              <el-input v-model="queryFormData.compress_tool_results" placeholder="请输入是否压缩工具结果" clearable />
            </el-form-item>
            ...
            <el-form-item label="是否生成追问" prop="followups">
              <el-input v-model="queryFormData.followups" placeholder="请输入是否生成追问" clearable />
            </el-form-item>
            ...
            <el-form-item label="是否对外暴露A2A接口" prop="a2a_enabled">
              <el-input v-model="queryFormData.a2a_enabled" placeholder="请输入是否对外暴露A2A接口" clearable />
            </el-form-item>
            <el-form-item label="是否为远程Agent" prop="is_remote">
              <el-input v-model="queryFormData.is_remote" placeholder="请输入是否为远程Agent" clearable />
            </el-form-item>
    ...
    >
      ...
      <template v-if="dialogVisible.type === 'detail'">
        <el-descriptions :column="4" border>
          ...
          <el-descriptions-item label="是否将知识库内容加入上下文" :span="2">
            {{ detailFormData.add_knowledge_to_context }}
          </el-descriptions-item>
          ...
          <el-descriptions-item label="是否将记忆加入上下文" :span="2">
            {{ detailFormData.add_memories_to_context }}
          </el-descriptions-item>
          <el-descriptions-item label="是否将历史记录加入上下文" :span="2">
            {{ detailFormData.add_history_to_context }}
          </el-descriptions-item>
          ...
          <el-descriptions-item label="输出结构体JSON Schema" :span="2">
            {{ detailFormData.output_schema }}
          </el-descriptions-item>
          ...
          <el-descriptions-item label="是否使用结构化输出" :span="2">
            {{ detailFormData.structured_outputs }}
          </el-descriptions-item>
          <el-descriptions-item label="是否解析响应" :span="2">
            {{ detailFormData.parse_response }}
          </el-descriptions-item>
          ...
          <el-descriptions-item label="是否指数退避重试" :span="2">
            {{ detailFormData.exponential_backoff }}
          </el-descriptions-item>
          <el-descriptions-item label="是否将当前时间加入上下文" :span="2">
            {{ detailFormData.add_datetime_to_context }}
          </el-descriptions-item>
          <el-descriptions-item label="是否将Agent名称加入上下文" :span="2">
            {{ detailFormData.add_name_to_context }}
          </el-descriptions-item>
          <el-descriptions-item label="是否压缩工具结果" :span="2">
            {{ detailFormData.compress_tool_results }}
          </el-descriptions-item>
          ...
          <el-descriptions-item label="是否对外暴露A2A接口" :span="2">
            {{ detailFormData.a2a_enabled }}
          </el-descriptions-item>
          <el-descriptions-item label="是否为远程Agent" :span="2">
            {{ detailFormData.is_remote }}
          </el-descriptions-item>
      ...
      <template v-else>
        ...
        >
          <el-form-item label="Agent名称" prop="name" :required="false">
          ...
          <el-form-item label="推理模型ID" prop="reasoning_model_id" :required="false">
            <el-input v-model="formData.reasoning_model_id" placeholder="请输入推理模型ID" />
          </el-form-item>
          <el-form-item label="输出模型ID" prop="output_model_id" :required="false">
            <el-input v-model="formData.output_model_id" placeholder="请输入输出模型ID" />
          </el-form-item>
          <el-form-item label="解析模型ID" prop="parser_model_id" :required="false">
            <el-input v-model="formData.parser_model_id" placeholder="请输入解析模型ID" />
          </el-form-item>
          ...
          <el-form-item label="学习机配置ID" prop="learning_config_id" :required="false">
            <el-input v-model="formData.learning_config_id" placeholder="请输入学习机配置ID" />
          </el-form-item>
          <el-form-item label="推理配置ID" prop="reasoning_config_id" :required="false">
            <el-input v-model="formData.reasoning_config_id" placeholder="请输入推理配置ID" />
          </el-form-item>
          <el-form-item label="压缩管理器配置ID" prop="compression_config_id" :required="false">
            <el-input v-model="formData.compression_config_id" placeholder="请输入压缩管理器配置ID" />
          </el-form-item>
          <el-form-item label="会话摘要配置ID" prop="session_summary_config_id" :required="false">
            <el-input v-model="formData.session_summary_config_id" placeholder="请输入会话摘要配置ID" />
          </el-form-item>
          <el-form-item label="文化管理器配置ID" prop="culture_config_id" :required="false">
            <el-input v-model="formData.culture_config_id" placeholder="请输入文化管理器配置ID" />
          </el-form-item>
          <el-form-item label="Agent指令" prop="instructions" :required="false">
            <el-input v-model="formData.instructions" placeholder="请输入Agent指令" />
          </el-form-item>
          ...
          <el-form-item label="附加上下文" prop="additional_context" :required="false">
            <el-input v-model="formData.additional_context" placeholder="请输入附加上下文" />
          </el-form-item>
          <el-form-item label="是否开启推理" prop="reasoning" :required="false">
            <el-input v-model="formData.reasoning" placeholder="请输入是否开启推理" />
          </el-form-item>
          <el-form-item label="最少推理步数" prop="reasoning_min_steps" :required="false">
            <el-input v-model="formData.reasoning_min_steps" placeholder="请输入最少推理步数" />
          </el-form-item>
          <el-form-item label="最多推理步数" prop="reasoning_max_steps" :required="false">
            <el-input v-model="formData.reasoning_max_steps" placeholder="请输入最多推理步数" />
          </el-form-item>
          <el-form-item label="是否开启学习" prop="learning" :required="false">
            <el-input v-model="formData.learning" placeholder="请输入是否开启学习" />
          </el-form-item>
          ...
          <el-form-item label="是否将知识库内容加入上下文" prop="add_knowledge_to_context" :required="false">
            <el-input v-model="formData.add_knowledge_to_context" placeholder="请输入是否将知识库内容加入上下文" />
          </el-form-item>
          ...
          <el-form-item label="是否将记忆加入上下文" prop="add_memories_to_context" :required="false">
            <el-input v-model="formData.add_memories_to_context" placeholder="请输入是否将记忆加入上下文" />
          </el-form-item>
          <el-form-item label="是否将历史记录加入上下文" prop="add_history_to_context" :required="false">
            <el-input v-model="formData.add_history_to_context" placeholder="请输入是否将历史记录加入上下文" />
          </el-form-item>
          <el-form-item label="加入上下文的历史运行次数" prop="num_history_runs" :required="false">
            <el-input v-model="formData.num_history_runs" placeholder="请输入加入上下文的历史运行次数" />
          </el-form-item>
          <el-form-item label="加入上下文的历史消息数" prop="num_history_messages" :required="false">
            <el-input v-model="formData.num_history_messages" placeholder="请输入加入上下文的历史消息数" />
          </el-form-item>
          ...
          <el-form-item label="工具选择策略(none/auto/specific)" prop="tool_choice" :required="false">
            <el-input v-model="formData.tool_choice" placeholder="请输入工具选择策略(none/auto/specific)" />
          </el-form-item>
          <el-form-item label="输出结构体JSON Schema" prop="output_schema" :required="false">
            <el-input v-model="formData.output_schema" placeholder="请输入输出结构体JSON Schema" />
          </el-form-item>
          ...
          <el-form-item label="是否使用JSON输出模式" prop="use_json_mode" :required="false">
            <el-input v-model="formData.use_json_mode" placeholder="请输入是否使用JSON输出模式" />
          </el-form-item>
          <el-form-item label="是否使用结构化输出" prop="structured_outputs" :required="false">
            <el-input v-model="formData.structured_outputs" placeholder="请输入是否使用结构化输出" />
          </el-form-item>
          <el-form-item label="是否解析响应" prop="parse_response" :required="false">
            <el-input v-model="formData.parse_response" placeholder="请输入是否解析响应" />
          </el-form-item>
          <el-form-item label="失败重试次数" prop="retries" :required="false">
            <el-input v-model="formData.retries" placeholder="请输入失败重试次数" />
          </el-form-item>
          <el-form-item label="重试间隔秒数" prop="delay_between_retries" :required="false">
            <el-input v-model="formData.delay_between_retries" placeholder="请输入重试间隔秒数" />
          </el-form-item>
          <el-form-item label="是否指数退避重试" prop="exponential_backoff" :required="false">
            <el-input v-model="formData.exponential_backoff" placeholder="请输入是否指数退避重试" />
          </el-form-item>
          <el-form-item label="是否将当前时间加入上下文" prop="add_datetime_to_context" :required="false">
            <el-input v-model="formData.add_datetime_to_context" placeholder="请输入是否将当前时间加入上下文" />
          </el-form-item>
          <el-form-item label="是否将Agent名称加入上下文" prop="add_name_to_context" :required="false">
            <el-input v-model="formData.add_name_to_context" placeholder="请输入是否将Agent名称加入上下文" />
          </el-form-item>
          <el-form-item label="是否压缩工具结果" prop="compress_tool_results" :required="false">
            <el-input v-model="formData.compress_tool_results" placeholder="请输入是否压缩工具结果" />
          </el-form-item>
          ...
          <el-form-item label="是否生成追问" prop="followups" :required="false">
            <el-input v-model="formData.followups" placeholder="请输入是否生成追问" />
          </el-form-item>
          <el-form-item label="追问数量" prop="num_followups" :required="false">
          ...
          <el-form-item label="调试级别" prop="debug_level" :required="false">
            <el-input v-model="formData.debug_level" placeholder="请输入调试级别" />
          </el-form-item>
          <el-form-item label="是否对外暴露A2A接口" prop="a2a_enabled" :required="false">
            <el-input v-model="formData.a2a_enabled" placeholder="请输入是否对外暴露A2A接口" />
          </el-form-item>
          <el-form-item label="是否为远程Agent" prop="is_remote" :required="false">
            <el-input v-model="formData.is_remote" placeholder="请输入是否为远程Agent" />
          </el-form-item>
          <el-form-item label="远程Agent地址" prop="remote_url" :required="false">
            <el-input v-model="formData.remote_url" placeholder="请输入远程Agent地址" />
          </el-form-item>
          <el-form-item label="远程Agent标识符" prop="remote_agent_id" :required="false">
