    ...
    <el-card class="data-table">
      <template #header>
        ...
        <div v-show="visible" class="search-container">
          ...
          >
            <el-form-item label="嵌入器名称" prop="name">
            ...
            <el-form-item>
              <el-button
                v-hasPerm="['module_agno_manage:embedders:query']"
                type="primary"
                icon="search"
                @click="handleQuery"
              >
      ...
      <div class="data-table__toolbar">
        <div class="data-table__toolbar--left">
          <el-row :gutter="10">
            <el-col :span="1.5">
              <el-button
                v-hasPerm="['module_agno_manage:embedders:create']"
                type="success"
                icon="plus"
            ...
            <el-col :span="1.5">
              <el-button
                v-hasPerm="['module_agno_manage:embedders:delete']"
                type="danger"
                icon="delete"
            ...
            <el-col :span="1.5">
              <el-dropdown v-hasPerm="['module_agno_manage:embedders:batch']" trigger="click">
          ...
          <el-row :gutter="10">
            <el-col :span="1.5">
              <el-tooltip content="导入">
                <el-button
                  v-hasPerm="['module_agno_manage:embedders:import']"
                  type="success"
                  icon="upload"
                  circle
            ...
            <el-col :span="1.5">
              <el-tooltip content="导出">
                <el-button
                  v-hasPerm="['module_agno_manage:embedders:export']"
                  type="warning"
                  icon="download"
                  circle
      ...
      >
        ...
        >
          <template #default="scope">
            <el-button
              v-hasPerm="['module_agno_manage:embedders:detail']"
              type="info"
              size="small"
              link
              icon="document"
            ...
            <el-button
              v-hasPerm="['module_agno_manage:embedders:update']"
              type="primary"
              size="small"
              link
              icon="edit"
    ...
    >
      ...
      <template v-if="dialogVisible.type === 'detail'">
        <el-descriptions :column="4" border>
          ...
          <el-descriptions-item label="自定义端点地址" :span="2">
...
const tableColumns = ref([
  ...
  { prop: "name", label: "嵌入器名称", show: true },
  { prop: "provider", label: "提供商", show: true },
  { prop: "model_id", label: "嵌入模型标识", show: true },
  { prop: "api_key", label: "API密钥", show: true },
  { prop: "base_url", label: "自定义端点地址", show: true },
  { prop: "dimensions", label: "向量维度", show: true },
  { prop: "config", label: "其他构造参数", show: true },
...
// 导出列（不含选择/序号/操作）
const exportColumns = [
  { prop: "name", label: "嵌入器名称" },
  { prop: "provider", label: "提供商" },
  { prop: "model_id", label: "嵌入模型标识" },
  { prop: "api_key", label: "API密钥" },
  { prop: "base_url", label: "自定义端点地址" },
  { prop: "dimensions", label: "向量维度" },
  { prop: "config", label: "其他构造参数" },
