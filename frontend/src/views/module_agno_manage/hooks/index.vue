  ...
  <div class="app-container">
    ...
    <el-card class="data-table">
        ...
        <div v-show="visible" class="search-container">
          ...
          >
            <el-form-item label="Hook名称" prop="name">
              <el-input v-model="queryFormData.name" placeholder="请输入Hook名称" clearable />
            </el-form-item>
            <el-form-item label="Hook类型(pre/post/tool)" prop="hook_type">
              <el-input v-model="queryFormData.hook_type" placeholder="请输入Hook类型(pre/post/tool)" clearable />
            </el-form-item>
            ...
            <el-form-item label="额外配置参数" prop="config">
              <el-input v-model="queryFormData.config" placeholder="请输入额外配置参数" clearable />
            </el-form-item>
            <el-form-item label="是否后台运行" prop="run_in_background">
              <el-input v-model="queryFormData.run_in_background" placeholder="请输入是否后台运行" clearable />
            </el-form-item>
            ...
            <el-form-item>
              <el-button
                v-hasPerm="['module_agno_manage:hooks:query']"
                type="primary"
                icon="search"
                @click="handleQuery"
              >
      ...
      <div class="data-table__toolbar">
        <div class="data-table__toolbar--left">
          <el-row :gutter="10">
            <el-col :span="1.5">
              <el-button
                v-hasPerm="['module_agno_manage:hooks:create']"
                type="success"
                icon="plus"
            ...
            <el-col :span="1.5">
              <el-button
                v-hasPerm="['module_agno_manage:hooks:delete']"
                type="danger"
                icon="delete"
            ...
            <el-col :span="1.5">
              <el-dropdown v-hasPerm="['module_agno_manage:hooks:batch']" trigger="click">
          ...
          <el-row :gutter="10">
            <el-col :span="1.5">
              <el-tooltip content="导入">
                <el-button
                  v-hasPerm="['module_agno_manage:hooks:import']"
                  type="success"
                  icon="upload"
                  circle
            ...
            <el-col :span="1.5">
              <el-tooltip content="导出">
                <el-button
                  v-hasPerm="['module_agno_manage:hooks:export']"
                  type="warning"
                  icon="download"
                  circle
      ...
      >
        ...
        />
        <el-table-column
          v-if="tableColumns.find((col) => col.prop === 'run_in_background')?.show"
          label="是否后台运行"
        ...
        >
          <template #default="scope">
            <el-button
              v-hasPerm="['module_agno_manage:hooks:detail']"
              type="info"
              size="small"
              link
              icon="document"
            ...
            <el-button
              v-hasPerm="['module_agno_manage:hooks:update']"
              type="primary"
              size="small"
              link
              icon="edit"
    ...
    >
      ...
      <template v-if="dialogVisible.type === 'detail'">
        <el-descriptions :column="4" border>
          ...
          <el-descriptions-item label="Hook类型(pre/post/tool)" :span="2">
          ...
          <el-descriptions-item label="额外配置参数" :span="2">
...
const tableColumns = ref([
  ...
  { prop: "name", label: "Hook名称", show: true },
  { prop: "hook_type", label: "Hook类型(pre/post/tool)", show: true },
...
// 导出列（不含选择/序号/操作）
const exportColumns = [
  { prop: "name", label: "Hook名称" },
  { prop: "hook_type", label: "Hook类型(pre/post/tool)" },
  { prop: "module_path", label: "Python模块路径" },
  { prop: "func_name", label: "函数名" },
  { prop: "config", label: "额外配置参数" },
  { prop: "run_in_background", label: "是否后台运行（不阻塞响应）" },
...
const rules = reactive({
  ...
  name: [{ required: false, message: "请输入Hook名称", trigger: "blur" }],
  hook_type: [{ required: false, message: "请输入Hook类型(pre/post/tool)", trigger: "blur" }],
  module_path: [{ required: false, message: "请输入Python模块路径", trigger: "blur" }],
  func_name: [{ required: false, message: "请输入函数名", trigger: "blur" }],
